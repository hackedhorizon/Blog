<div>
    ...
    <div x-data="LivewireUIModal()" x-on:close.stop="setShowPropertyTo(false)"
        ...
        style="display: none;">
        <div class="flex items-start justify-center min-h-screen px-4 pt-4 pb-10 text-center">
            ...
            <div x-show="show && showActiveComponent" x-transition:enter="ease-out duration-300"
                ...
                class="inline-block w-full overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-screen-md"
